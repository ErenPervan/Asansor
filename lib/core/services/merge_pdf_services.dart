...
void main() {
  ...
  var pdfReportServicePath =
      'd:/Asansor/lib/core/services/pdf_report_service.dart';
  ...
  var reportLogic = pdfReportContent.substring(
    pdfReportContent.indexOf('// ¦¦ Corporate colour palette'),
  );
  ...
  reportLogic = reportLogic.replaceAll(
