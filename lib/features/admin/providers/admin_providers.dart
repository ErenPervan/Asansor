...
final allSchedulesProvider = FutureProvider.autoDispose<List<ScheduleModel>>((
  ref,
) {
...
final technicianScheduleStreamProvider = StreamProvider.autoDispose<List<ScheduleModel>>((
  ref,
) {
  final user = ref.watch(authControllerProvider).valueOrNull;
...
class ScheduleController extends AsyncNotifier<ScheduleModel?> {
  ...
  Future<void> assignTask({
    ...
    final createdBy = ref.read(authControllerProvider).valueOrNull?.id ?? '';
...
class MasterCalendarFilterNotifier
  ...
  void setTechnician(String? id) => state = state.copyWith(technicianId: id);
...
final masterCalendarFilterProvider =
    AutoDisposeNotifierProvider<
      MasterCalendarFilterNotifier,
...
final autoScheduleControllerProvider =
