...
import 'package:asansor/features/admin/widgets/master_calendar/master_calendar_error_view.dart';
import 'package:asansor/features/admin/widgets/master_calendar/master_calendar_filter_sheet.dart';
import 'package:asansor/features/admin/widgets/master_calendar/master_calendar_workspace.dart';
...
class _AdminMasterCalendarViewState
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: allAsync.when(
        ...
        error: (e, st) => MasterCalendarErrorView(
          error: e,
  ...
  void _showFilterSheet(BuildContext context, List<ScheduleWithDetails> all) {
    showModalBottomSheet<void>(
      ...
      builder: (_) => MasterCalendarFilterSheet(allSchedules: all),
    );
  }
