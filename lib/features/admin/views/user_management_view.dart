...
import 'package:asansor/features/admin/widgets/user_management/user_management_header.dart';
import 'package:asansor/features/admin/widgets/user_management/user_management_tabs.dart';
        ...
        children: [
          ...
          Expanded(
            child: TabBarView(
              controller: _tabs,
              children: [
                UserListTab(role: UserRole.technician, query: _query),
                CustomerTab(query: _query),
                UserListTab(role: null, query: _query),
              ],
            ),
          ),
        ],
