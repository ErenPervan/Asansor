...
import 'package:asansor/features/maintenance/widgets/maintenance_log_entry/maintenance_checklist_panel.dart';
import 'package:asansor/features/maintenance/widgets/maintenance_log_entry/maintenance_form_hero.dart';
import 'package:asansor/features/maintenance/widgets/maintenance_log_entry/maintenance_notes_panel.dart';
import 'package:asansor/features/maintenance/widgets/maintenance_log_entry/maintenance_photo_panel.dart';
import 'package:asansor/features/maintenance/widgets/maintenance_log_entry/maintenance_signatures_panel.dart';
import 'package:asansor/features/maintenance/widgets/maintenance_log_entry/maintenance_submit_bar.dart';
...
class _MaintenanceLogEntryViewState
  ...
  Future<void> _submit() async {
    ...
    final userId = ref.read(currentProfileProvider).value?.id;
    if (userId == null) {
