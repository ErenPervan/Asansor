-- Migration: 20260603000003_secure_resolve_conflict_rpc.sql
-- Description: Adds strict role authorization to the SECURITY DEFINER RPC.
...
BEGIN
  ...
  -- SECURITY DEFINER bypasses RLS, so we MUST check the role explicitly.
  IF public.current_user_role() != 'admin' THEN
    RAISE EXCEPTION 'Unauthorized: Only admins can resolve conflicts';
  END IF;
